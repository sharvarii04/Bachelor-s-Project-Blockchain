...
/**
 * Servlet implementation class P_request_accept
 */
@WebServlet("/P_request_accept")
public class P_request_accept extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public P_request_accept() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String Patient_Status = "Transplantation Done";
				...
				st.executeUpdate("update tbl_request_organ set Patient_Status='"
						+ Patient_Status
				...
				ResultSet rs=sts.executeQuery("select * from tbl_request_organ where B_ID='"+D_ID+"'");
				if(rs.next())
				{
			...
			pw.println("<script> alert('User Request Accept Successfully');</script>");
